...
public class UserRestController {
    ...
    //1. Client 로 Domain Object + 기타 Data 를 JSON 으로 전송할 경우.
    //요청 미디어 타입 : application/json ==> 즉 데이터교환 json
...
//    }
    ...
    //2.1 Client fh Domain Object + 기타 Data 를 JSON 으로 전송할 경우
    //http://IP:8080/Spring14/user/json/getUser/user01
    ...
    public Map getUser(@PathVariable String value,
        ...
        //==> 단순히 name = value 의 Data 를 저장하는 경우는 ???
        return map;
    }
